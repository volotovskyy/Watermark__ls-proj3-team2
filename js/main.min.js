...
var Base = (function () {
    ...
    var _loadMainImage = function () {
        ...
        Scale.mainImage();
        _positionAdd([0,0]); // îáíîâëÿåì ïîçèöèþ watermark
    };
...
var Grid = (function () {
    ...
    var _getCenterPositionBlockByIndex = function (index) {
        var size = Images.getSizeMainImage(),
            ...
            hCountBlock = index / sizeGrid.col >> 0, // íîìåð áëîêà â ñòîëáöå
            wCountBlock = index % sizeGrid.col;      // íîìåð áëîêà â ñòðîêå
...
var Images = (function () {
    ...
    var _loadImg = function (e, func) {
        if (window.File && window.FileReader && window.FileList && window.Blob) {
            ...
            if (!file.type.match('image.*')) {
                alert('ÐžÑˆÐ¸Ð±ÐºÐ°. Ð¢Ð¾Ð»ÑŒÐºÐ¾ Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ñ!');
    ...
    var _save = function (e) {
        ...
        if ($inputImage1.prop('files').length === 0 || $inputImage2.prop('files').length === 0) {
            alert('Ð¡Ð½Ð°Ñ‡Ð°Ð»Ð° Ð²Ñ‹Ð±ÐµÑ€Ð¸Ñ‚Ðµ Ð¸Ð·Ð¾Ð±Ñ€Ð°Ð¶ÐµÐ½Ð¸Ðµ');
            //TODO print message
            return;
        }
